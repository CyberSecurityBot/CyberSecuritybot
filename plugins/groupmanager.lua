...
if msg.to.type ~= 'pv' then
  ...
  if matches[1] == "help" and is_mod(msg) then
    if not lang then
      text = [[
      *CyberSecurityInfo Bot Commands:*
